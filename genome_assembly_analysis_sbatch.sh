...
#SBATCH --mem=5G
#SBATCH --error=genome_assembly_analysis_run.%J.err
#SBATCH --output=genome_assembly_analysis_run.%J.out

log_dir="$(pwd)"
log_file="logs/genome_assembly_analysis.log.txt"
...
cp genome_assembly_analysis_sbatch.sh $snakemake_file_dir 
cp genome_assembly_analysis_run* $snakemake_file_dir
